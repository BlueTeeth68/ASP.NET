...
public class CustomAuthController : ControllerBase
{
    ...
    public CustomAuthController(IConfiguration config, SignInManager<User> signInManager,
    ...
    {
        var result = await signInManager.PasswordSignInAsync(loginRequestModel.Email, loginRequestModel.Password, false,
